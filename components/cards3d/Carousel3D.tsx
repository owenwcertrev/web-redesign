    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex items-center justify-center gap-4 mt-8">
        <button
          ...
          className="w-12 h-12 rounded-full bg-white border-2 border-charcoal/10 hover:border-primary/30 hover:bg-primary/5 transition-all flex items-center justify-center group shadow-lg"
        >
          <ChevronLeft className="w-5 h-5 text-charcoal/60 group-hover:text-primary transition-colors" />
        </button>
        ...
        <button
          ...
          className="w-12 h-12 rounded-full bg-white border-2 border-charcoal/10 hover:border-primary/30 hover:bg-primary/5 transition-all flex items-center justify-center group shadow-lg"
        >
          <ChevronRight className="w-5 h-5 text-charcoal/60 group-hover:text-primary transition-colors" />
        </button>
      </div>
    </div>
  )
