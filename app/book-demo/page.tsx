        ...
        <div className="py-24 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-block mb-3 px-5 py-2 bg-white rounded-full border-2 border-coral/20 shadow-sm"
            >
              <span className="text-xs font-semibold text-navy tracking-wide">MEET THE FOUNDERS</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 leading-tight font-serif"
            >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <FadeIn>
            <div className="text-center mb-8">
              <div className="inline-block mb-3 px-5 py-2 bg-coral/10 rounded-full border-2 border-coral/30 shadow-md">
                <span className="text-xs font-semibold text-navy tracking-wide">GET STARTED</span>
              </div>
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-navy font-serif">
