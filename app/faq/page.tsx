          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-navy tracking-wide">FREQUENTLY ASKED QUESTIONS</span>
              </div>
            </motion.div>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`
                    flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full font-semibold text-xs sm:text-sm md:text-base transition-all
                    ${isActive
                      ? tab.color === 'coral'
